...
[sel02 text="Go to see Riri"][locate x="&sf.selold_x[0]" y="&sf.selold_y[2]"][button graphic="selectimage" recthit=false target=*Go to see Riri]
[sel04 text="I'll refrain"    ][locate x="&sf.selold_x[0]" y="&sf.selold_y[4]"][button graphic="selectimage" recthit=false target=*I'll refrain]
[s]
*梨里に会いに行く
[fc]
*5307|梨里に会いに行く
