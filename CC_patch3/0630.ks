...
[sel02 text="1F Emergency Exit"][locate x="&sf.selold_x[0]" y="&sf.selold_y[2]"][button graphic="selectimage" recthit=false target=*1F Emergency Exit]
[sel04 text="2F Emergency Exit"][locate x="&sf.selold_x[0]" y="&sf.selold_y[4]"][button graphic="selectimage" recthit=false target=*2F Emergency Exit]
[s]
*ÇPFÇÃîÒèÌå˚
[fc]
*7857|ÇPFÇÃîÒèÌå˚
