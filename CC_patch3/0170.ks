...
*1563|
[fc]
Even as night practice began, Rui-senpai's mood remained sour.[pcms]
*1564|
[fc]
She walked around the poolside with long strides, muttering complaints[r]
under her breath.[pcms]
[backlay][mis_lo_01_f07 layer=1 x="&sf.mi_lo_x[1]" y="&sf.mi_lo_y[0]"][trans time=150 method=crossfade][wt]
*1565|
[fc]
[vo_mo s="misuzu0038"]
[ns]Nenohi[nse]
...
*1567|
[fc]
Wow... she's completely sulked, hasn't she, senpai...[pcms]
*1568|
[fc]
It's cute, but... At this rate, she'll only get more of a reputation[r]
as a sorry case.[pcms]
*1569|
[fc]
I really wish she'd cheer up soon... It's hard to watch.[pcms]
[stopse_all]
[sysbt_meswin clear]
[backlay][black_toplayer][trans time=501 method=crossfade][wt2][hide_chara_int]
[fadeoutbgm time=500]
[wait2 time=1000]
[jump storage="0180.ks"]
