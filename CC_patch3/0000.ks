...
[locate x="&sf.zap_x[0]" y="&sf.zap_y[0]"][button graphic="zap_secret" target=*secret_start]
...
[openvideo storage="視点変更_シークレットファイル.mpg"]
[playvideo]
[if exp="sf.bgmplay == 1"]
[video volume=55]
